...
func addDefaultBiz(ctx context.Context, db dal.RDB, conf *upgrader.Config) error {
	...
	defaultBiz["bk_supplier_account"] = conf.OwnerID
	...
	defaultSet["bk_supplier_account"] = conf.OwnerID
	...
	defaultResModule["bk_supplier_account"] = conf.OwnerID
	...
	defaultFaultModule["bk_supplier_account"] = conf.OwnerID
